...
<head>
	...
	<!-- CSSkue -->
	<link rel="stylesheet" href="<?= base_url() ?>assets/css/style_material.css">
...
<body>
	<!-- fullscreen slider -->
	<div class="slider fullscreen animated zoomIn slow">
		<ul class="slides">
			<li>
				<img src="<?= base_url() ?>assets/img/t1.jpg" class="responsive-img"> <!-- random image -->
				<div class="caption left-align">
					<h3>My Website is</h3>
					<h5 class="light grey-text text-lighten-3">awalberbagi.epizy.com</h5>
				</div>
			</li>
			<li>
				<img src="<?= base_url() ?>assets/img/t2.jpg" class="responsive-img"> <!-- random image -->
				<div class="caption center-align">
					<h3>What's up guys?</h3>
					<h5 class="light grey-text text-lighten-3">Semoga bahagia sehat wal afiat ya aamiin.</h5>
				</div>
			</li>
			<li>
				<img src="<?= base_url() ?>assets/img/space.jpg" class="responsive-img"> <!-- random image -->
				<div class="caption center-align">
					<h3>This website was created by Codeigniter 3.1.9</h3>
					<h5 class="light grey-text text-lighten-3">Semoga bermanfaat</h5>
				</div>
			</li>
			<li>
				<img src="<?= base_url() ?>assets/img/t6.jpg" class="responsive-img"> <!-- random image -->
				<div class="caption center-align">
					<h3>What is going on?</h3>
					<h5 class="light grey-text text-lighten-3">Silahkan eksplorasi</h5>
				</div>
			</li>
			<li>
				<img src="<?= base_url() ?>assets/img/t8.jpg" class="responsive-img"> <!-- random image -->
				<div class="caption right-align">
					<h3>My quote of the day is</h3>
					<h5 class="light grey-text text-lighten-3"><em>"Saling berbagi itu indah."</em></h5>
				</div>
			</li>
		</ul>
	</div>
	<!--akhir fullscreen slider  -->

	<!-- awal button -->
	<div class="center">
		<a class="btn waves-effect white grey-text text-darken-4 animated fadeInDown slow hoverable tooltipped" data-position="top" data-tooltip="Sugeng Rawuh" href="<?= base_url() ?>home/landing" target="_blank">Masuk</a>
	</div>
	<!-- akhir button -->
	...
	<div class="row valign-wrapper">
		<div class="col s12 m12 l12">
			<div class="center">
				<h3 id="typing"><span id="teks"></span></h3>
			</div>
		</div>
	</div>
	<!-- akhir typedkue -->
	...
	<script src="<?= base_url() ?>assets/js/script_material.js"></script>
